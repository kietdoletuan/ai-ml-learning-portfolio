...
- Result: Best model used 200 trees with `max_depth=5`, reaching 82% test accuracy and outperforming the previous Decision Tree by 1%. OOB error stabilised around 100 trees. `Fare`, `Sex`, and `Age` were among the most influential features. Includes a local Gradio app for interactive Titanic survival predictions.
