...
- Result: Best configuration is 200 trees at max_depth 5 achieved 81% test accuracy, outperforming the single Decision Tree by 1% probably due to the simplicity of the dataset. OOB error stabilised at approximately 100 trees. Sex and Age still ranked highly, but RF surfaced Fare as another important feature — a feature the Decision Tree largely ignored.
